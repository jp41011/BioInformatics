...
private:
	...
	string pattern; // patten for prog2
...
public:
	...
	*/
	Exon(string&, unsigned long int&, unsigned long int&, string&, unsigned long int&, bool, string);
	// accessor functions
	...
	string getPattern(); // get the patterned that is stored
